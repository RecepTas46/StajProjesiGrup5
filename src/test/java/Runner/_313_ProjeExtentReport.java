...
@CucumberOptions(
   tags = {"@SetupParameters,@EducationExtentReport,@HumanResourcesSetup,@BudgetExtentReport"},
...
public class _313_ProjeExtentReport extends AbstractTestNGCucumberTests {
